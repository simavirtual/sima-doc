...
* Se imprime el recibo aplicando un recargo por el recibo que no se facturó.
...
Documentar las actividades que se deben tener presente para el buen manejo del sistema del control de ingresos para la correcta facturación de los recibos
...
* Tesorero o persona encargada de facturar los recibos de pago en cada institución educativa.
...
* El manual del tesorero lo debe conocer el departamento de contabilidad del distrito, por interación de procesos para entender las actividades que se
  realizan en el sistema de facturación, que son el soporte de los movimientos contables.

=== PROCESOS DEL SISTEMA DE FACTURACION

* El sistema de facturación es el encargado de facturar los conceptos por servicios educativos a los padres de familia y por esta razón
...
** Procesos de tipo técnico.

** Procesos de tipo operativo.

==== PROCESOS DE TIPO ADMINISTRATIVO

Son todos los controles y políticas que se deben tener presentes para garantizar que todos los procesos que involucre el sistema sean correctos y confiables.

Los controles deben ser de dos tipos internos y externos

==== PROCESOS DE TIPO TECNICO

Son todos aquellos procesos que tienen que ver con la evolución y mantenimiento del Software o programa.

Mantenimiento es cuando se corrigen errores y evolución cuando se responde a requerimientos nuevos o que cambian.

==== PROCESOS DE TIPO OPERATIVO

Los procesos operativos tienen que ver con el buen manejo del programa u operación del sistema
...
* LA CONCILIACION DE LA CONTABILIDAD. "Es el control contable o auditoría del Sistema.
